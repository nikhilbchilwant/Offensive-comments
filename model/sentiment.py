...
class SentimentModel(BaseModel):
    def __init__(self, pretrained_model_names = ["oliverguhr/german-sentiment-bert"], num_classes = 3):
        super().__init__()
        self.model = BertForSequenceClassification.from_pretrained(pretrained_model_names[0])
